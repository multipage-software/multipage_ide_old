...
public abstract class AreaEditorPanelBase extends JPanel {
	 ...
	 * Listeners.
	 */
	protected ActionListener isStartListener;
	 ...
	 * @return
	 */
	protected abstract JCheckBox getCheckBoxIsStartArea();
	...
	public void createListeners() {
		...
		isStartListener = new ActionListener() {
	...
	protected void localize() {
		...
		Utility.localize(getCheckBoxIsStartArea());
	 ...
	 * On is start action.
	 */
	protected void onIsStartAction() {
		
		getCheckBoxIsStartArea().removeActionListener(isStartListener);

		// Get state.
		boolean isStart = getCheckBoxIsStartArea().isSelected();
		
		// If the global area is a home area, inform user and exit.
		if (area.getId() == 0L && !isStart) {
			
			getCheckBoxIsStartArea().setSelected(true);
			getCheckBoxIsStartArea().addActionListener(isStartListener);
		...
		long areaId = isStart ? area.getId() : 0L;
		
		getCheckBoxIsStartArea().setSelected(!isStart);
	...
	protected void setStartAreaCheckbox() {
		...
		getCheckBoxIsStartArea().setSelected(area.getId() == startAreaId.ref);
