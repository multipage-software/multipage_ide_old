 ...
 *
 */
public class ReceiversAuxiliaryTable {
	 ...
	 * @return
	 */
	public static ReceiversAuxiliaryTable createFrom(
		...
		ReceiversAuxiliaryTable conditionalEventsTable = new ReceiversAuxiliaryTable();
	 ...
	 * @param handles
	 */
	private void addReceivers(Object receiverObject, EventCondition condition, Integer priority,
	 ...
	 * @param handle
	 */
	public void addReceiver(Object receiverObject, EventCondition eventCondition, Integer priority,
			EventHandle handle) {
	...
	public LinkedHashMap<EventCondition, LinkedHashMap<Integer, LinkedHashMap<Object, LinkedList<EventHandle>>>> retrieveSorted() {
		...
		LinkedHashMap<EventCondition, LinkedHashMap<Integer, LinkedHashMap<Object, LinkedList<EventHandle>>>> sortedReceivers =
