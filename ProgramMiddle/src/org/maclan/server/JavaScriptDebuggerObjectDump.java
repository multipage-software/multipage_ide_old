...
public class JavaScriptDebuggerObjectDump extends JDialog {
	...
	private void initComponents() {
		...
		setTitle("org.maclan.server.titleDebuggerMessage");
		setBounds(100, 100, 450, 420);
		SpringLayout springLayout = new SpringLayout();
		getContentPane().setLayout(springLayout);
		
		labelObjectProperties = new JLabel("org.maclan.server.textObjectProperties");
		...
		buttonBreak = new JButton("org.maclan.server.textBreak");
		...
		buttonRun = new JButton("org.maclan.server.textRun");
		...
		buttonNext = new JButton("org.maclan.server.textNext");
